...
def main():
    ...
    parsed_malenames = parser.parse(lambda tup:(tup[0],tup[1]))  # TODO: Parse the rank and male-name tuples with your lambda.
    ...
    for male in parsed_malenames:
        for female in parsed_femalenames:
            if male[1]==female[1]:
                common_names.append(male[1]+": "+male[0]+", "+female[0])
